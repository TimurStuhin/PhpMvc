...
class ProductDAO{
    ...
    public function AddProduct($name, $inner_title, $short_description, $description, $category, $status, $grid_type, $price){
        
        
        $sql = 'insert into products(name, inner_title, short_description, description, id_category, status, grid_type, price) '.
                'values(:name, :inner_title, :short_description, :description, :id_category, :status, :grid_type, :price)';
    ...
    public function UpdateProduct($product){
        ...
        $sql = 'update products set name = :name, inner_title = :inner_title, short_description = :short_description, description = :description, '.
                'id_category = :id_category, status = :status, grid_type = :grid_type, price = :price, image = :image where id = :id';
